...
public class ChiTietSinhHieuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chi_tiet_sinh_hieu);
        addControls();
        addEvents();
        btnNgay.callOnClick();
    }
...
//        entries.add(new BarEntry(18, 7));
        ...
        dataSet.setColors(ColorTemplate.rgb("EE87E4"));
