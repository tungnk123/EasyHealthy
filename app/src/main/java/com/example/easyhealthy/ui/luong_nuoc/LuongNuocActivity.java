package com.example.easyhealthy.ui.luong_nuoc;
...
public class LuongNuocActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luong_nuoc);
        addControls();
        addEvents();
        btnNgay.callOnClick();
    }
    ...
    private void addEvents() {
        btnThemDuLieu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AddLuongNuocActivity.class);
