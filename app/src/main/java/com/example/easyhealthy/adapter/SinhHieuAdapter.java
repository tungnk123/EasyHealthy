...
public class SinhHieuAdapter extends RecyclerView.Adapter<SinhHieuAdapter.ListItemHolder> {
    ...
    public SinhHieuAdapter(List<HoatDongData> dataSet) {
    ...
    public ListItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.sinh_hieu_item, parent, false);
